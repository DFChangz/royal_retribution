...
$(BIN_DIR)/game: $(OBJS_DIR)/game.o $(OBJS_DIR)/engine.o $(OBJS_DIR)/error_handler.o $(OBJS_DIR)/event_handler.o $(OBJS_DIR)/image.o $(OBJS_DIR)/sprite.o $(OBJS_DIR)/character.o $(OBJS_DIR)/enemy.o $(OBJS_DIR)/collision_detector.o $(OBJS_DIR)/audio.o $(OBJS_DIR)/state.o $(OBJS_DIR)/playing_state.o $(OBJS_DIR)/text.o $(OBJS_DIR)/menu_state.o $(OBJS_DIR)/highscore_state.o
	$(C++) $(OBJS_DIR)/engine.o $(OBJS_DIR)/error_handler.o $(OBJS_DIR)/game.o $(OBJS_DIR)/image.o $(OBJS_DIR)/event_handler.o $(OBJS_DIR)/sprite.o $(OBJS_DIR)/character.o $(LDLIBS) $(OBJS_DIR)/enemy.o $(OBJS_DIR)/audio.o $(OBJS_DIR)/collision_detector.o $(OBJS_DIR)/state.o $(OBJS_DIR)/playing_state.o $(OBJS_DIR)/text.o $(OBJS_DIR)/menu_state.o $(OBJS_DIR)/highscore_state.o -o $(BIN_DIR)/game
